...
<!--(⊙o⊙)…一种呈现方式-->
<section id="?" class="box-content box-1">
    <div class="container">
        <div class="row heading">
            <div class="col-lg-12">
                <h2>最新动态</h2>
                <hr>
                <div class="intro"><a href="newList.php">更多动态</a> </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-3 box-item">
                ...
                <h3 class="blue">**会议感悟</h3>
                <p>网易MOOC知名老师,开有诸多慕课,本校中教学Java,C,OOP和操作系统,体系等课程</p>
                <button type="submit" class="btn btn-2 " onclick="{location.href='Newcontent.php'}" value="?" >detail</button>
            </div>
            <!--					<div class="col-sm-3 box-item">-->
            <!--						<div class="wrap-img">-->

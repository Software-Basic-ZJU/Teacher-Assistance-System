...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-12-21 14:46:58
-- 服务器版本： 5.7.11
-- PHP Version: 7.0.4
...
(10000, '今天去游玩', '真的好好玩&lt;p&gt;SADFSDFS&lt;/p&gt;', '2016-12-09 20:28:39', '1234567', '杨奕辉', '0'),
(10001, '阿斯顿发生', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '2016-12-09 19:53:34', '1234567', '111\'', '0'),
(10002, '撒旦法撒旦', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '2016-12-09 19:59:33', '1234567', '发送到发', '0'),
(10003, '撒旦法撒旦', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '2016-12-09 19:59:50', '1234567', '发送到发', '0'),
(10004, 'asdf', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '2016-12-09 20:02:56', '1234567', 'sdfsd', '0'),
(10017, '今天去游玩', '真的好好玩双方都胜多负少东方闪电撒旦法撒旦&lt;/p&gt;', '2016-12-09 20:41:26', '1234567', '杨奕辉', '0'),
(10018, '今天去游玩', '真的好好玩双方都胜多负少东方闪电&amp;lt;/p&amp;gt;&lt;p&gt;范德萨范德萨&lt;/p&gt;', '2016-12-09 20:42:45', '1234567', '杨奕辉', '0'),
(10020, '水电费', '&amp;lt;p&amp;gt;&amp;lt;br&amp;gt;&amp;lt;/p&amp;gt;&lt;p&gt;发斯蒂芬&lt;/p&gt;', '2016-12-09 20:47:15', '1234567', '地方', '0'),
(10021, 'dsfsd', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '2016-12-09 22:23:06', '1234567', 'dsfdsfsd', '0');
...
INSERT INTO `classes` (`class_id`, `term`, `year`, `name`) VALUES
(10001, b'0', 2016, '软工1班'),
(10002, b'0', 2016, '软工2班');
...
--
-- 转存表中的数据 `class_teacher`
--

INSERT INTO `class_teacher` (`class_id`, `teacher_id`, `assist_id`) VALUES
(10001, '1234567', NULL),
(10002, '1234567', NULL);
...
INSERT INTO `homework` (`hw_id`, `title`, `publish_time`, `deadline`, `class_id`, `type`, `over`, `punish_type`, `punish_rate`) VALUES
(10001, '第二次作业', '2016-12-10 21:36:52', '2016-12-17 21:36:55', 10002, '1', '0', '0', 0.8);
...
(10004, '我试一试长一点的留言会怎样\r\n不知道这里回车有用吗\r\n老师这门课考核是怎么算分的\r\n有期末考试嘛？', '游客(::1)', '2016-12-14 09:35:41', '1', 'aaa\r\n'),
(10005, 'sdfs', '游客(::1)', '2016-12-14 13:13:33', '0', NULL),
(10006, '可见', '游客(::1)', '2016-12-18 21:58:58', '0', NULL),
(10007, '1234667', '游客(::1)', '2016-12-18 21:59:08', '0', NULL),
(10008, '阿斯蒂芬', '游客(::1)', '2016-12-18 22:21:33', '0', NULL),
(10009, '士大夫但是', '游客(::1)', '2016-12-18 22:21:45', '0', NULL),
(10010, '三墩发', '游客(::1)', '2016-12-18 22:22:41', '0', NULL),
(10011, 'test一下\r\n', '游客(::1)', '2016-12-19 23:14:11', '0', NULL);
...
INSERT INTO `notification` (`noti_id`, `title`, `content`, `level`, `time`, `teacher_id`) VALUES
(10001, 'asdf', '&lt;p&gt;fsdfs&lt;/p&gt;', '0', '2016-12-09 16:27:00', '1234567'),
(10002, 'fasdf', '&lt;p&gt;fsdaf&lt;/p&gt;', '0', '2016-12-09 16:27:39', '1234567'),
(10004, 'fadsfas', '&lt;p&gt;fsdfsd&lt;/p&gt;', '0', '2016-12-09 16:33:10', '1234567'),
(10008, '反倒是反倒是', '&lt;p&gt;范德萨发的&lt;/p&gt;', '0', '2016-12-09 18:09:15', '1234567'),
(10011, '的所得税法', '&lt;p&gt;鼎折覆餗的&lt;/p&gt;', '1', '2016-12-09 21:55:43', '1234567'),
(10019, 'fsdfsd撒旦法撒旦', '&lt;p&gt;发送到&lt;/p&gt;', '0', '2016-12-09 22:40:56', '1234567'),
(10020, 'fsdfsd撒旦法撒旦', '&lt;p&gt;发送到发生的发生的&lt;/p&gt;', '0', '2016-12-09 22:41:05', '1234567'),
(10021, 'fsdfsd', '&lt;p&gt;水电费&lt;/p&gt;', '0', '2016-12-09 22:42:35', '1234567'),
(10022, 'testtset', '&lt;p&gt;水电费&lt;/p&gt;', '0', '2016-12-09 22:42:47', '1234567'),
(10023, '范德萨范德萨', '&lt;p&gt;fdsfs 等等&lt;/p&gt;', '1', '2016-12-11 17:51:34', '1234567');
...
INSERT INTO `posts` (`post_id`, `teacher_id`, `section`, `title`, `content`, `author_id`, `group_id`, `publish_time`, `update_time`) VALUES
(10000, '1234567', '0', '第一次发帖', '请多多关照', '1234567', NULL, '2016-12-12 18:39:11', '2016-12-12 18:39:15'),
(10001, '1234567', '0', '的神烦大叔', '&lt;p&gt;的神烦大叔&lt;/p&gt;', '1234567', 0, '2016-12-12 22:11:48', '2016-12-12 22:11:48');
...
INSERT INTO `questions` (`ques_id`, `title`, `content`, `hw_id`, `submit_num`, `average_score`, `type`, `ques_finish`) VALUES
(10000, '第三方', '&lt;p&gt;辅导辅导地方的&lt;/p&gt;', 10004, 0, 0, '0', '0');
...
INSERT INTO `resource` (`resrc_id`, `name`, `path`, `size`, `time`, `type`, `post_id`, `uploader_id`, `authority`) VALUES
(1, '测试1', './resource/1.txt', 1, '2016-12-12 19:00:00', '0', NULL, '', '0'),
(2, '测试2', './resource/excel.xlsx', 1, '2016-12-12 19:00:00', '0', NULL, '', '0'),
(3, '测试3', './resource/word.docx', 1, '2016-12-12 19:00:00', '0', NULL, '', '0'),
(4, '测试4', './resource/pdf.pdf', 1, '2016-12-12 19:00:00', '0', NULL, '', '0'),
(5, '测试5', './resource/ppt.pptx', 1, '2016-12-12 19:00:00', '0', NULL, '', '0'),
(10036, '水电费', 'upload/7e387ccf52427d520dcea284.docx', 13401, '2016-12-12 19:10:43', '0', NULL, '1234567', '0'),
(10066, 'SQL', 'upload/155655abc56e24d6c6522575.sql', 20053, '2016-12-12 22:51:26', '0', NULL, '1234567', '0'),
(10067, '360Safe.exe', 'upload/89a2452b5ae5f65599d7bd03.exe', 962984, '2016-12-12 22:51:36', '0', NULL, '1234567', '0');
...
INSERT INTO `student` (`uid`, `student_id`, `password`, `name`, `email`, `question1`, `question2`, `answer1`, `answer2`, `class_id`, `group_id`, `check_code`) VALUES
(10000, 'yyh951102', 'c92f606717d8826c16893e9bacdd6c47', '杨奕辉', NULL, NULL, NULL, NULL, NULL, 10001, NULL, NULL);
...
INSERT INTO `teacher` (`uid`, `teacher_id`, `password`, `name`, `phone`, `email`, `wechat`, `qq`, `other_contact`, `teacher_info`, `course_info`, `photo_path`, `brief_intro`) VALUES
(10001, '1', '123456', '邢卫', '13958030163', 'wxing@zju.edu.cn', NULL, NULL, NULL, '邢卫老师，男，1967年生，浙江大学计算机科学与技术学院博士，副教授，硕士生导师。1992年起先后在浙江大学工业控制技术国家实验室、浙江大学信息学院控制科学与工程系、浙江大学计算机科学与技术学院任职；1994年晋升讲师，2000年12月晋升副教授；2011年2月至2012年7月作为援疆干部，任塔里木大学信息工程学院副院长，学校信息化工作领导小组办公室常务副主任。近年来，作为课题负责人承担国家科技支撑计划项目课题“动漫内容的发布交易技术与服务”和浙江省重大科技计划项目“数字媒体网络家庭智能终端研究与开发”、“多层次职业技术教育网络平台研究与应用示范”等多项；作为技术负责人或主要骨干承担国家自然科学基金重点项目“数字媒体网络系统及关键技术研究”、国家科技支撑计划项目“现代农村信息化关键技术研究与示范”项目“基层农村综合信息服务技术集成与应用”课题、教育部“百万册数字图书服务系统IPv6升级”项目、浙江省重大科技攻关项目“浙江省信息化科技村镇建设与示范”、“农村党员干部现代远程教育工程关键技术与设备研究及其应用”等多项。获得科研成果3项、获省部级科技奖励2项，获发明专利授权4项，发表学术论文20余篇，持有软件著作权20余项。主要研究方向包括计算机网络技术和多媒体技术。近十年已有30多位研究生在他指导下毕业并获得学位。', '软件需求工程', 'images/teacher/1.jpg', '邢卫老师是计算机学院计算机系的系主任。对待教学工作认真负责，教学效果优秀。'),
(10002, '2', '123456', '林海', '+86 571 88206683', 'lin@cad.zju.edu.cn', NULL, NULL, NULL, 'Dr. Hai Lin is a professor in State Key Lab. of CAD&CG, Zhejiang University. He got M.Eng and B.Eng from Xidian University  in 1990 and 1987 respectively. He joined in State Key Lab. of CAD&CG in 1990. After he obtained a PhD in computer science from Zhejiang University, he had been a Research Fellow in Medical Visualization at De Montfort University, UK from 2000 to 2003. He was a visiting professor of the Department of Computing and Information Systems,  University of Bedfordshire, UK. His research interests include computer graphics, scientific visualization, volume rendering, virtual reality and graphical electromagnetic computing.\r\n个人主页：http://www.cad.zju.edu.cn/home/lin/', '软件需求工程', 'images/teacher/2.jpg', '林海老师，浙江大学CAD&CG国家重点实验室固定研究人员，研究科学计算可视化。'),
(10003, '3', '123456', '刘玉生', '0086-571-87951045', 'ysliu@cad.zju.edu.cn', NULL, NULL, NULL, '刘玉生，男，1970年生，博士，浙江大学计算机学院研究员，博士生导师，CAD&CG国家重点实验室固定研究人员。1995年7月在浙江大学获硕士学位后赴澳门贺田工业有限公司从事机电产品的研发。1997年9月起在浙江大学机械制造及自动化专业攻读博士学位并于2000年9月毕业。同年10月进入浙江大学CAD&CG国家重点实验室从事博士后研究，2002年10月出站后前往在香港城市大学继续从事博士后研究。2003年4月开始在浙江大学计算机学院CAD&CG国家重点实验室任固定研究人员，2007年晋升为研究员，2008年被评为博士生导师。2009年8月至2010年8月在佐治亚理工学院基于模型的系统工程中心从事访问研究一年，取得了满意的访问成果。近年来主要从事软件工程、MBSE、模型驱动产品设计、三维形貌检测、三维模型检索、计算机辅助公差建模等方面的研究，共发表论文30余篇，其中SCI收录13篇，EI收录20余篇，作为第一作者或通讯作者，在国际顶级期刊和著名期刊CAD、IEEE T-ASE、Pattern Recognition等发表的论文已取得较大影响，同时也是上述国际期刊的通讯评委。\r\n个人主页：http://www.cad.zju.edu.cn/home/ysliu/#Research_Interests', '软件需求工程', 'images/teacher/3.jpg', '刘玉生老师，浙江大学CAD&CG国家重点实验室固定研究人员，研究计算机辅助设计。'),
(10004, '4', '123456', '金波', '', '', NULL, NULL, NULL, '这是金波老师的个人详细介绍。', '软件工程管理', 'images/default.jpg', '金波老师，浙江大学系统结构与网络安全研究所固定研究人员。'),
(10005, '1234567', '21232f297a57a5a743894a0e4a801fc3', '杨奕辉', '172555222', '234347589@qq.com', 'fsd', '334345', 'fsdfds', '这是教师信息fsdfsd都是&amp;lt;p&amp;gt;ds fsd&amp;lt;/p&amp;gt;&lt;p&gt;f第三方水电费&lt;/p&gt;', '&lt;p&gt;这是课程信息&amp;amp;lt;p&amp;amp;gt;asdfsdfsdf&amp;amp;lt;/p&amp;amp;gt;&amp;lt;p&amp;gt;sdfsd&amp;lt;/p&amp;gt;&lt;/p&gt;&lt;h2&gt;dfdfgdf&lt;/h2&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'images/default.jpg', '给你一句简要介绍');
...
ALTER TABLE `notification`
  ...
  ADD KEY `class_id` (`teacher_id`) USING BTREE;
...
--
ALTER TABLE `article`
  MODIFY `art_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10022;
--
...
--
ALTER TABLE `classes`
  MODIFY `class_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10003;
--
...
--
ALTER TABLE `homework`
  MODIFY `hw_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10002;
--
...
--
ALTER TABLE `message`
  MODIFY `msg_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10012;
--
-- 使用表AUTO_INCREMENT `notification`
--
ALTER TABLE `notification`
  MODIFY `noti_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10024;
--
-- 使用表AUTO_INCREMENT `posts`
--
ALTER TABLE `posts`
  MODIFY `post_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10002;
--
-- 使用表AUTO_INCREMENT `questions`
--
ALTER TABLE `questions`
  MODIFY `ques_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10001;
--
...
--
ALTER TABLE `resource`
  MODIFY `resrc_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10068;
--
-- 使用表AUTO_INCREMENT `student`
--
ALTER TABLE `student`
  MODIFY `uid` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10001;
--
-- 使用表AUTO_INCREMENT `teacher`
--
ALTER TABLE `teacher`
  MODIFY `uid` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10006;
--

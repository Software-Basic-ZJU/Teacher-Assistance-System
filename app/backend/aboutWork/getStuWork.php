...
$query_result = mysqli_query($conn, "select * from works join (select ques_id, questions.title as ques_title,homework.title as hw_title,questions.type as type
...
if($query_result){
    ...
    $result = array(
        ...
        "res" => array(
            ...
            "path"=>"https://".$_SERVER['HTTP_HOST']."/app/backend/aboutResource/".$resrcFetch['path'],
